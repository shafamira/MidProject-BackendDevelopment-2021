        ...
        <div class="section-top-border">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <h4 class="mb-30">Submit an application for course enrollment</h4>
                    @guest
                    ...
                    <form method="POST" action="{{ route('enroll.store', $course->id) }}">
                        @csrf
                        <div class="mt-10">
                            <input type="text" name="name" placeholder="Full Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'"
                             required class="single-input">
                        </div>
                        <div class="mt-10">
                            <input type="email" name="email" placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'"
                        ...
                        <div class="mt-10">
                            <input type="number" name="phone-number" placeholder="Phone Number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone Number'"
                            required class="single-input">
                        </div>
                        <div class="mt-10">
                            <input type="number" name="age" placeholder="Age" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Age'"
                            required class="single-input">
                        </div>
                        <div class="mt-10">
                            <input type="date" name="birthdate" placeholder="Birth Date" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Birth Date'"
                            required class="single-input">
                        </div>
